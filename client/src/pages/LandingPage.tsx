        ...
        <div className={styles.container}>
            ...
            <section className={styles.hero}>
                <div className={styles.heroContent}>
                    <img src="/icon.png" alt="WhatIF" className={styles.heroLogo} />
                    ...
                    <p className={styles.subtitle}>
                        WhatIF simulates multiple future timelines for your life decisions,
            ...
            <footer className={styles.footer}>
                <div className={styles.footerContent}>
                    <div className={styles.footerLogo}>
                        <img src="/icon.png" alt="WhatIF" />
                    </div>
                    <p>Powered by Gemini 3 Flash • Built for AI Hackathon 2026</p>
                </div>
            </footer>
        </div>
    );
